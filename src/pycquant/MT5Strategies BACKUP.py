...
class PctStrategies():
    ...
    def __init__(self, symbol, timeframe, pct_up=True, last_close=False, last_open=False, current_open=False):

        self.symbol = symbol
        self.timeframe = dict[timeframe]
        self.pct_up = pct_up
    ...
    def place_order(abc):
        if (abc.pct_up and abc.last_close):
            print('pct_up and last close')
        elif (not abc.pct_up and abc.last_close):
            print('pct_down and last close')
        elif (abc.pct_up and abc.last_open):
            print('pct_up and last open')
        elif (not abc.pct_up and abc.last_open):
            print('pct_down and last open')
        elif (abc.pct_up and abc.current_open):
            print('pct_up and current open')
        elif (not abc.pct_up and abc.current_open):
            print('pct_down and current close')
